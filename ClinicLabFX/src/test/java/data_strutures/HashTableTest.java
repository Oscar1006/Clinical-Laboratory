...
public class HashTableTest {
	...
	private void stage2() {
		patients = new HashTable<>();
		patients.insert("1006048521", new Patient("Jun", "1006048521", 21, "Candelaria", "david_jhun@outlook.es", false, false, false, false, Calendar.getInstance())); 
		...
		patients.insert("1617181920", new Patient("Mario", "1617181920", 50, "Italia", "mario@gmail.com", false, false, false, false, Calendar.getInstance()));
		patients.insert("2021222324", new Patient("Julio", "2021222324", 25, "Cesar", "julio@hotmail.com", false, true, true, true, Calendar.getInstance()));
	}
